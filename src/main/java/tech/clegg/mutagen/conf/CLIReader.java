...
public class CLIReader
{
    ...
    private void initOptions()
    {
        ...
        opts.addOption(Option.builder(OptionNames.GEN_ONLY_MUTAGEN_UPDATED_MUTANTS)
                .desc("Only use mutants generated by MutaGen-unique operators, specifically the final " +
                        "functionality operator subset.")
                .build());
